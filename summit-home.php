<?php
/*
Template Name: Summit - Home
*/
get_header();
$post_data = get_post($post->post_parent);
$parent = $post_data->post_name;
$parent = substr($parent,0,4);
$args = array( 'post_type' => 'summit_sponsors', 'post_status'=>'publish','meta_key'=>'banner','meta_compare'=>'>','meta_value'=>'0','numberposts'=>10);
...
<div id="blBlog">
    ...
    <div class="bl_left">
        ...
        <div class="bl_post">
            ...
            <a target="_blank" href="http://<?php echo $random_sponsor_link['link'][0]?>">
        ...
        <div id="prev_next">
            ...
            <div id="next_link" id="prev_link"><?php echo previous_posts_link('') ?></div>
        </div>
    </div>
    <!-- End bl_left -->
    <div class="blClear"></div>
