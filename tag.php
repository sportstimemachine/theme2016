					...
					<?php
						...
						<div class="bl_post">
	                                <div class="bl_left_side">
	                                	<div class="bl_img"><div class="bl_img"><?=get_avatar($post->post_author,50);?></div></div>
	                                    <div class="bl_post_day"><b><?=date("j",strtotime($post->post_date))?></b><br/><?=date("F",strtotime($post->post_date))?></div>
